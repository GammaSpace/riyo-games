...
{ #if article.title != undefined }
  ...
  <div class="w-full relative flex flex-wrap justify-center items-center">
    ...
    <div class="z-20 relative mission-mask flex flex-wrap p-8 pb-20 justify-center items-center -mt-16">
      <div class="bg-careersBandMidBg bg-top bg-tan bg-no-repeat absolute w-full h-full"></div>
        ...
        <div class="w-full">
          ...
          <div class="py-4 text-textGray">
            {#each positions as job, id }
              <div class="my-2 px-4 py-4 bg-whiteTan">
                <div class="w-full relative flex flex-wrap justify-center items-center font-menu">
                  ...
                  <div class="w-full text-center md:w-auto">
                    <button 
                      ...
                      class="uppercase my-2 md:my-0 font-menu text-center w-[120px] md:w-[140px] h-[40px] bg-charcoal text-beige hover:text-boxBlue px-4 py-2">
                      {posDom[id][1]}
                    </button>
                  </div>
                </div>
                <div bind:this={posDom[id][0]} class="max-h-0 overflow-y-hidden toggle-job">
                  <div class="style-job py-4 text-textGray">
